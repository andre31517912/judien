          ...
          <div>
            ...
            <div className="relative w-full">
              <button
                ...
                className="relative w-full aspect-[4/1] rounded-xl border-2 border-dashed border-gray-300 dark:border-gray-600 overflow-hidden bg-gray-50 dark:bg-gray-800 hover:border-indigo-400 dark:hover:border-indigo-500 transition flex items-center justify-center"
              >
                {editPhotoUrl ? (
                  ...
                  <div className="flex flex-col items-center gap-2 pointer-events-none">
                    ...
                    <span className="text-sm text-gray-400 dark:text-gray-500">{zh ? '上傳照片' : 'Upload Photo'}</span>
                  </div>
                )}
                {groupPhotoUploading && (
            ...
            {showGroupPhotoModal && editPhotoUrl && (
              <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm" onClick={() => setShowGroupPhotoModal(false)}>
