              ...
              >
                {editPhotoUrl ? (
                  ...
                  <div className="flex flex-col items-center gap-2 pointer-events-none">
                    ...
                    <span className="text-sm text-gray-400 dark:text-gray-500">{zh ? '點擊上傳封面' : 'Click to upload'}</span>
                  </div>
                )}
                <div className="absolute bottom-2 right-2 w-8 h-8 rounded-full bg-indigo-600 flex items-center justify-center shadow-md">
                  {groupPhotoUploading ? (
